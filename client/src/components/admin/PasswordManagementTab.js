...
import { Search, Filter, Key, Eye, Clock, AlertTriangle, CheckCircle, Loader, RefreshCw, Users, Shield } from 'lucide-react';
...
const PasswordManagementTab = () => {
  ...
  }, [pagination.page, pagination.limit, searchTerm, selectedSchool]);
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-700">
            Manage and reset passwords for school administrators
          </p>
        </div>
