-- Manual Password Management Migration SQL
-- Run this script directly in your PostgreSQL database if the automated migration fails
...
SELECT 'Migration completed successfully' as status,
       ...
       (SELECT COUNT(*) FROM users WHERE role = 'admin' AND password_reset_required = TRUE) as admins_requiring_reset,
       (SELECT COUNT(*) FROM password_reset_logs) as total_audit_logs;
